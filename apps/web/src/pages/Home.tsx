...
const Home: Component = () => {
  ...
  return (
    <div class="min-h-screen flex flex-col bg-white text-gray-900 font-sans selection:bg-black selection:text-white">
      ...
      {/* Footer */}
      <footer class="py-6 border-t border-gray-50">
        <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:justify-between gap-3 text-[11px] text-gray-400">
          <div class="flex items-center gap-3">
            ...
            <a href="https://github.com/nologin-tools/AskMeAnythi.ng/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 transition-colors">MIT</a>
          </div>
          <div class="flex items-center gap-3">
            <a href="https://x.com/AskMeAnythi_ng" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-gray-900 transition-colors" aria-label="X (Twitter)">
            ...
            <a href="https://github.com/nologin-tools/AskMeAnythi.ng" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-gray-900 transition-colors" aria-label="GitHub">
            ...
            <a href="https://nologin.tools/badge/askmeanythi-ng" target="_blank" rel="noopener noreferrer" class="hover:opacity-80 transition-opacity" aria-label="NoLogin Verified">
              <img src="https://nologin.tools/badges/flat.svg" alt="NoLogin Verified" class="h-4" loading="lazy" />
            </a>
          </div>
        </div>
      </footer>
